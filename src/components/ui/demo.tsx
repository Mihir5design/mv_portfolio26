  ...
  return (
    <section className="relative flex min-h-[560px] w-full items-center overflow-hidden bg-background">
      ...
      <button
        ...
        className="absolute right-4 top-4 z-20 inline-flex items-center gap-2 rounded-full border border-border bg-background/80 py-1.5 pl-1.5 pr-3 text-sm text-foreground backdrop-blur cursor-pointer"
      >
        <span
          aria-hidden
